...
public class DashboardService {
    ...
    public List<VenueBooking> getPendingBookings() {
        return venueBookingRepository.findByStatus(Status.PENDING);
    }

    public List<VenueBooking> getApprovedBookings() {
        return venueBookingRepository.findByStatus(Status.APPROVED);
    }

    public List<VenueBooking> getBookingsByUser(Long userId) {
        return venueBookingRepository.findByRequestedBy(userId);
    }
}
